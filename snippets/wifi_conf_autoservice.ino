...
char device_id[40]; //monitoring device ID, used for identification
char api_endpoint[129] = "http://powietrze.obywatelskint.pl/api/airquality_send.php"; //air monitoring API URL, default value
...
void setup() {
  ...
  //clean FS, for testing, comment out in production, otherwise device will always boot in config mode
  //SPIFFS.format();
